...
execute if data storage uws:settings banned_effects[{name:anchor}] run return run function uws:libraries/internal/text/already_banned_effect

data modify storage uws:temp effect.name set value anchor
