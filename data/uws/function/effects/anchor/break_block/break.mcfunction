...
execute on attacker if score @s uws.anchor_id = #temp_anchor_id uws.state run function uws:effects/anchor/break_block/reset_placement with storage uws:temp player