...
$execute facing entity @n[type=!$(ignored_entities),tag=!uws.omitted,distance=..$(tracking_radius)] eyes positioned 0.0 0.0 0.0 summon minecraft:marker run function uws:effects/homing/loop/get_motion with storage uws:temp entity_data
