item modify entity @s contents [{"function":"minecraft:set_item","item":"minecraft:iron_ingot"},{"function":"minecraft:set_components","components":{"!minecraft:custom_data":{}}}]
