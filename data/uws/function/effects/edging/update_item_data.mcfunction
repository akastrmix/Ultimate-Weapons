...
execute if score #temp_gametime uws.state < @s uws.edging_time run return run execute if function uws:libraries/effect/is_weapon_hints_enabled run function uws:libraries/effect/display_cooldown {effect:edging,equipment:weapon}
