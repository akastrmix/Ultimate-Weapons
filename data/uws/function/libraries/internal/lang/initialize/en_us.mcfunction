...
data modify storage uws:lang en_us."text.applied_effect" set value {"text":"Applied effect "}
data modify storage uws:lang en_us."text.to_item" set value {"text":" to your item"}
data modify storage uws:lang en_us."text.not_holding_item" set value {"text":"You are not holding any item"}
data modify storage uws:lang en_us."text.item_not_support_effect" set value {"text":"Your item does not support this effect"}
data modify storage uws:lang en_us."text.item_already_has_effect" set value {"text":"Your item already has this effect"}

data modify storage uws:lang en_us."text.banned_effect" set value {"text":"Successfully banned effect "}
data modify storage uws:lang en_us."text.view_banlist" set value {"text":"[View Banlist]","hoverEvent":{"action":"show_text","contents":"Click here to put the command in chat"}}
data modify storage uws:lang en_us."text.already_banned_effect" set value {"text":"This effect is already banned"}
data modify storage uws:lang en_us."text.unbanned_effect" set value {"text":"Successfully unbanned effect "}
data modify storage uws:lang en_us."text.unbanned_all_effects" set value {"text":"Successfully unbanned all effects"}
...
data modify storage uws:lang en_us."text.voidbox.no_second_to_link" set value {"text":"You didn't have another Voidbox to link with the one you just placed, so it turned into an Ender Chest"}
data modify storage uws:lang en_us."text.voidbox.placement_reset" set value {"text":"Your Voidbox placement status has been reset"}
data modify storage uws:lang en_us."text.voidbox.teleported_to_origin" set value {"text":"You have been teleported back to the original location"}